...
def set_user_lang(tg_id: int, lang: str) -> None:
    _user_langs[tg_id] = lang if lang in TRANSLATIONS else DEFAULT_LOCALE


def user_localize(tg_id: int, key: str, /, **kwargs: Any) -> str:
    lang = _user_langs.get(tg_id, get_locale())
