...
class EnvKeys(ABC):
    ...
    # TipzySMM
    TIPZY_API_KEY: Final = _get_optional("TIPZY_API_KEY", "")
    TIPZY_BASE_URL: Final = _get_optional("TIPZY_BASE_URL", "https://tipzysmm.ru/api/v2")
    TIPZY_SERVICE_ID: Final = int(_get_optional("TIPZY_SERVICE_ID", "513"))
    TIPZY_COST_PER_UNIT_RUB: Final = float(_get_optional("TIPZY_COST_PER_UNIT_RUB", "0.02"))
    TIPZY_SELL_PER_UNIT_RUB: Final = float(_get_optional("TIPZY_SELL_PER_UNIT_RUB", "0.05"))

    # Platega
    PLATEGA_SHOP_ID: Final = _get_optional("PLATEGA_SHOP_ID", "")
    PLATEGA_SECRET_KEY: Final = _get_optional("PLATEGA_SECRET_KEY", "")
    PLATEGA_WEBHOOK_SECRET: Final = _get_optional("PLATEGA_WEBHOOK_SECRET", "")
    PLATEGA_MERCHANT_ID: Final = _get_optional("PLATEGA_MERCHANT_ID", "")
    ADMIN_API_KEY: Final = _get_optional("ADMIN_API_KEY", "changeme")
    FREEMODEL_ADMIN_KEY: Final = _get_optional("FREEMODEL_ADMIN_KEY", "")
